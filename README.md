...
The code is in develop branch. This code is AI Market web project which is display web pages and front end logics. AI Market server project is [here](https://github.com/ATNIO/aimarket_server).
...
Using models to maintain state's data, models contains:

* Subscription
* Effect
* Reducer

Users start a action by dispatch, Effect receive it and start a new action using yield put, then Reducer received and change state, pages will change according to state.
